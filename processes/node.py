...
class Node(spec_pb2_grpc.Node):
    ...
    def __init__(self, args):
        ...
        self.args = args
        self.parentInfo: spec_pb2.RegisterReply = self.coordinator.Register(
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "-p", "--port", help="Port to run the node process on.", default=5201)
    parser.add_argument("-c", "--coordinator",
                        help="Port of the coordinator process.", default=5200)
